...
const props = defineProps<{
  webhookConfig: EventosWebhookConfig
  hasSession: boolean
...
const emit = defineEmits<{
  'update-config': [updates: Partial<EventosWebhookConfig>]
  'clear-config': []
}>()
      ...
      <Tabs default-value="webhook">
        ...
        <TabsContent value="webhook">
          <div class="space-y-4 pt-2">
            <div class="flex items-center justify-between">
              <Alert variant="info" class="flex-1">
                <AlertDescription class="text-sm">
                  ...
                  <code class="bg-blue-100 dark:bg-blue-900 px-1 rounded">Eventos</code>.
                </AlertDescription>
              </Alert>
              <Button
                variant="ghost"
            ...
            <div v-if="webhookConfig.enabled" class="space-y-3 pl-4 border-l-2 border-amber-300 ml-2">
              <div>
              ...
              <div>
                ...
                <div class="flex items-center gap-2">
                  <Badge variant="info">Eventos</Badge>
                  <span class="text-xs text-muted-foreground">(Eventos y Egresados)</span>
                </div>
              </div>
              ...
              <div v-if="webhookConfig.simulateBypass" class="space-y-3 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
                <div>
        ...
        <TabsContent value="session">
          <div class="space-y-4 pt-2">
            ...
            <div>
              ...
              <Badge variant="info" class="mt-1">eventos</Badge>
            </div>
          </div>
        </TabsContent>
